...
<template>
  ...
  <div class="mobile-drawer" :class="{ open: mobileOpen }">
    ...
    <router-link to="/resume" @click="closeMobile">Resume</router-link>
    <router-link to="/contact" @click="closeMobile">Contact</router-link>
  </div>
  <router-view />
  <footer role="contentinfo">
    <span class="foot-text">© 2026 Maxene Quiambao</span>
    <div class="foot-socials">
      <a href="https://github.com/maxqmb" target="_blank" rel="noopener" class="foot-icon" aria-label="GitHub">
      ...
      <a href="https://www.linkedin.com/in/max-quiambao-a8952a341/" target="_blank" rel="noopener" class="foot-icon" aria-label="LinkedIn">
